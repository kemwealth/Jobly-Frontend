...
//         }
//       }
//       setInfoLoaded(true); // Ensure loading state is updated
//     };

//     loadUserInfo(); // Invoke the user info loading function
//   }, [token]);
...
//     try {
//       await JoblyApi.jobApply(currentUser.username, id); // Await the API call
//       setAppliedJobIds((prevIds) => new Set(prevIds).add(id)); // Update applied job IDs more efficiently
//     } catch (err) {
//       console.error("Error applying for job", err); // Log any errors that occur during job application
//     }
//   };
